...
Использована библиотека scikit-learn и алгоритм кластеризации DBSCAN.
Параметры подобраны на основе условий ТЗ для автоматического
разделения точек на кластеры, отсеивания аномалий и последующего
вычисления расстояний с помощью scipy.
"""
