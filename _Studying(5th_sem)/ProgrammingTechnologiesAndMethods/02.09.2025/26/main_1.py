...
"""
Запуск:
python main_1.py 26.txt
Вывод:
9991 5643

Алгоритм с предварительной обработкой данных, использующий хэш-таблицы
для эффективного поиска ограничений и нахождения оптимального решения
без полного перебора всех рядов.
"""
