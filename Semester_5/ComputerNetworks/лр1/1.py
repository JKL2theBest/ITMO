...
S = f_v - f_n
print(
    f"Манчестер: f_в={f_v/1e6:.1f} МГц, f_н={f_n/1e6:.1f} МГц, f_ср={f_sr/1e6:.1f} МГц, S={S/1e6:.1f} МГц"
)
print("-" * 30)
...
S = f_v - f_n
print(
    f"NRZ (N={N_nrz}): f_в={f_v/1e6:.1f} МГц, f_н={f_n/1e6:.1f} МГц, f_ср={f_sr/1e6:.1f} МГц, S={S/1e6:.1f} МГц"
)
print("-" * 30)
...
S = f_v - f_n
print(
    f"RZ: f_в={f_v/1e6:.1f} МГц, f_н={f_n/1e6:.1f} МГц, f_ср={f_sr/1e6:.1f} МГц, S={S/1e6:.1f} МГц"
)
print("-" * 30)
...
S = f_v - f_n
print(
    f"AMI (N={N_ami}): f_в={f_v/1e6:.1f} МГц, f_н={f_n/1e6:.1f} МГц, f_ср={f_sr/1e6:.1f} МГц, S={S/1e6:.1f} МГц"
)
print("-" * 30)
...
S = f_v - f_n
print(
    f"NRZI (N={N_nrzi}): f_в={f_v/1e6:.1f} МГц, f_н={f_n/1e6:.1f} МГц, f_ср={f_sr/1e6:.1f} МГц, S={S/1e6:.1f} МГц"
)
print("-" * 30)
